...
public:
	...
	// drawing functions
	void draw(const std::string& id, int x, int y, double angle = 0, int alpha = 255, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE, float resize = 1.0f);
	void drawCut(const std::string& id, int x, int y, int cutLeft, int cutRight, int cutTop, int cutDown,
		double angle = 0, int alpha = 255, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE, float resize = 1.0f);
	...
	void playAnimation(const std::string& sprite_sheet_name, Animation& animation, int x, int y, float speed_factor, double angle, int alpha, bool centered = true, SDL_RendererFlip flip = SDL_FLIP_NONE, float resize = 1.0f);
	void playAnimation(Sprite* sprite, std::string animation_name, float speed_factor, double angle, int alpha, SDL_RendererFlip flip = SDL_FLIP_NONE);
